...
;(function () {
  ...
  var author = ' ipsum-0320'
  var github = ' https://github.com/ipsum-0320/ipsum-0320.github.io'
...
blog.addLoadEvent(function () {
  ...
  function initDarkMode(flag) {
    ...
    blog.removeClass($header_logo, 'icon-theme-light-logo')
    blog.removeClass($header_logo, 'icon-theme-dark-logo')
    if (flag === 'true') {
      blog.addClass($icon, 'icon-theme-dark')
      blog.addClass($header_logo, 'icon-theme-dark-logo')
    } else {
      blog.addClass($icon, 'icon-theme-light')
      blog.addClass($header_logo, 'icon-theme-light-logo')
    }
...
blog.addLoadEvent(function () {
  ...
  blog.removeClass($header_logo, 'icon-theme-light-logo')
  blog.removeClass($header_logo, 'icon-theme-dark-logo')
  if (localStorage.darkMode === 'true') blog.addClass($header_logo, 'icon-theme-dark-logo')
  else blog.addClass($header_logo, 'icon-theme-light-logo')
})